...
public class Loginpage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText(" Enter Hostname");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                ...
                if(jTextField1.getText().equals(hostName) && jTextField2.getText().equals(dbName)
                 || jTextField3.getText().equals(user) && jTextField4.equals(password) )
              {
 
                
                   String.format("jdbc:sqlserver://10.10.132.50;databaseName=Azure_COE",
